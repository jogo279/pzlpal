...
(function($){
  $.fn.crossword = function(entryData) {
      ...
      */
      ...
      //this.after('<div id="well puzzle-clues"><div style="float:left;padding:10px"><h2>Across</h2><ul id="across" style="list-style-type: none;"></ul></div><div style="float:left;padding:10px"><h2>Down</h2><ul id="down" style="list-style-type: none;"></ul></div></div>');
        ...
        */
        buildEntries: function() {
          ...
          entries.forEach(function (entry) {
            var coords = entry[0];
            if ($("td[data-coords='" + coords + "'] span#little-num").length == 0) {
              $("td[data-coords='" + coords + "']").append("<span id='little-num'>" + (num++) + "</span>");
            }
          });
          util.highlightEntry();
          util.highlightClue();
